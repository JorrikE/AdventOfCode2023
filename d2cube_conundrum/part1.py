...
def get_sum_of_possible_game_ids(input_path: Path, reference_info_dict: dict[str, int]):
    sum_of_ids: int = 0
...
if __name__ == "__main__":
    reference_info_dict: dict[str, int] = {"red": 12,
                                           "green": 13,
                                           "blue": 14}
    print(get_sum_of_possible_game_ids(INPUT_PATH, reference_info_dict))
